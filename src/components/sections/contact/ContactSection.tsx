...
export default function ContactSection() {
  return (
    ...
    >
      ...
      {/* CONTENT */}
      <div className="grid grid-cols-1 lg:grid-cols-[420px_1fr] gap-6 sm:gap-8 md:gap-10 lg:gap-12">
        {/* FORM + SOCIAL LINKS */}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>@joyal-b-biju</div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>@JoyalBBiju</div>
                </div>
              </a>

              {/* Email */}
              <a
                href="mailto:joyalbbiju@gmail.com"
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: 12,
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>joyalbbiju@gmail.com</div>
                </div>
              </a>
            </div>
          </div>
      ...
      <div className="mt-20 text-center text-xs text-white/35">
        © 2026 Joyal Biju — All rights reserved.
      </div>
    </section>
  )
}
